...
for it=1:It,
    ...
    if mod(it, 100) == 0,
        fprintf('After %d iterations, cost on test set is %f, correct ratio on test set is %f\n', ...
            it, cost_function(X, y, m, n1, n2, n3, theta, lambda), correct_ratio(X, y, m, n1, n2, n3, theta));
        fprintf('After %d iterations, cost on cross validation set is %f, correct ratio on cross validation set is %f\n', ...
            it, cost_function(X_cv, y_cv, m_cv, n1, n2, n3, theta, lambda), correct_ratio(X_cv, y_cv, m_cv, n1, n2, n3, theta));
    end;
end;
